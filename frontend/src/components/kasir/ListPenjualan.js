...
function ListPenjualan() {
  ...
  const exportToExcel = () => {
    ...
    const wsData = filteredPenjualan.map((penjualandetail) => {
      // Menggabungkan semua detail perawatan ke dalam satu kolom
      ...
      return {
        ...
        Metode_Pembayaran: findMetodeById(penjualandetail.details[0].metodeDet), // Mengambil metode pembayaran dari detail pertama
      };
    });
    ...
    // Menambahkan data total ke worksheet yang sama
